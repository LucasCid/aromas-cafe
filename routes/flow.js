...
router.post('/create-payment', async (req, res) => {
    try {
        ...
        const paymentData = {
            ...
            // paymentMethod: 9 causa problemas, mejor omitir o usar 1
            // 1 = Webpay, 2 = Servipag, 3 = Multicaja, 9 = Todos
            // Si omites este parámetro, Flow muestra todos los disponibles
